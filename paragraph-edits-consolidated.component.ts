...
export class ParagraphEditsConsolidatedComponent {
  ...
  private initializeHighlights(): void {
    ...
    this.paragraphEdits.forEach((p: any, idx: number) => {
      ...
      // Do not overwrite if display fields were explicitly set elsewhere
      p.displayOriginal = p.displayOriginal ?? highlighted.original;
      p.displayEdited = p.displayEdited ?? highlighted.edited;
    });
  }
